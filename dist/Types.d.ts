...
export type WithFeatures<A extends Atom<any>, FF extends Feature<any, any, any, any>[]> = (A extends Atom<infer T, infer U, infer F> ? Atom<T, U, IntersectFeatures<[F, ...FF]>> : never);
